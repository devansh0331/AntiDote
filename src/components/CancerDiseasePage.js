...
function CancerDiseasePage() {
    ...
    //Agr cancer mein koi click krta hai toh cancer 
  ...
  return (
    ...
    <div className="diseasePageContent">
        ...
        <h1><strong>{disease.cancer.disease}</strong> </h1>
        <p>{disease.cancer.content}</p>
        <p><strong>Symptoms : </strong>{disease.cancer.symptoms}</p>
    </div>
        <img src={disease.cancer.diseaseImg} alt=""/>
    ...
    <div className="diseasePageDoctors">
        ...
        {disease.cancer.docs.map((items , key) => {
...
export default CancerDiseasePage
