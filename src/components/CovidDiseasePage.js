...
function CovidDiseasePage() {
    ...
    //Agr covid mein koi click krta hai toh covid 
  ...
  return (
    ...
    <div className="diseasePageContent">
        ...
        <h1><strong>{disease.covid.disease}</strong> </h1>
        <p>{disease.covid.content}</p>
        <p><strong>Symptoms : </strong>{disease.covid.symptoms}</p>
    </div>
        <img src={disease.covid.diseaseImg} alt=""/>
    ...
    <div className="diseasePageDoctors">
        ...
        {disease.covid.docs.map((items , key) => {
...
export default CovidDiseasePage
