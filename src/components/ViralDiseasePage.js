...
function ViralDiseasePage() {
    ...
    //Agr viral mein koi click krta hai toh viral 
  ...
  return (
    ...
    <div className="diseasePageContent">
        ...
        <h1><strong>{disease.viral.disease}</strong> </h1>
        <p>{disease.viral.content}</p>
        <p><strong>Symptoms : </strong>{disease.viral.symptoms}</p>
    </div>
        <img src={disease.viral.diseaseImg} alt=""/>
    ...
    <div className="diseasePageDoctors">
        ...
        {disease.viral.docs.map((items , key) => {
...
export default ViralDiseasePage
